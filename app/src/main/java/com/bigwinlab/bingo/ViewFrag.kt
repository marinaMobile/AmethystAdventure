...
import com.bigwinlab.bingo.MAinCla.Companion.lknfr
import com.bigwinlab.bingo.databinding.FragmentView2Binding
...
class ViewFrag : Fragment() {
    ...
    private var _binding: FragmentView2Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentView2Binding.inflate(inflater, container, false)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val spoon = requireActivity().getSharedPreferences("SP_WEBVIEW_PREFS", AppCompatActivity.MODE_PRIVATE)

        val sharPref = requireActivity().getSharedPreferences("SP", MODE_PRIVATE)
        ...
        Log.d("MainId", mainId.toString())

        val pack = "com.bigwinlab.bingo"

        val afId = AppsFlyerLib.getInstance().getAppsFlyerUID(requireActivity())
        ...
        val first = "http://"
        val second = "amethystadventure.xyz/go.php?to=2&"
    ...
    fun saveUrl(url: String?) {
        if (!url!!.contains("t.me")) {
            ...
            if (firstUrl == "") {
                firstUrl = requireActivity().getSharedPreferences(
                    "SP_WEBVIEW_PREFS",
                ...
                val sp = requireActivity().getSharedPreferences("SP_WEBVIEW_PREFS", AppCompatActivity.MODE_PRIVATE)
                val editor = sp.edit()
